...
g.opera.postError(b):alert(b)}}}});f.extend({event:{portable:function(a){return a?a:g.event},getTarget:function(a){a=bg.event.portable(a);return a.target||a.srcElement}}});f.extend({input:{toggleCheckBox:function(a,b){bg.input.boxAction(a,"toggle",b)},getRadioValue:function(a){return bg.input.boxAction(document.getElementsByName(a),"value")},getCheckBoxValues:function(a){a=bg.input.boxAction(document.getElementsByName(a),"value");return a==null?"":a},boxAction:function(a,b,c){var d="",e,i;if(a)if(a[0])for(i=
0;i<a.length;i++)if(b=="selected"){if(a[i].checked)return a[i].checked}else if(b=="value"){if(a[i].checked)a[i].type=="radio"?d=a[i].value:a[i].type=="checkbox"&&(d!=""&&(d+=","),d+=a[i].value)}else{if(b=="toggle"&&(e=f.event.getTarget(c),a[i].checked=e.checked,typeof a[i].onchange=="function"))a[i].onchange()}else if(b=="selected")return a.checked;else if(b=="value"){if(a.checked)d=a.value}else if(b=="toggle"&&(e=f.event.getTarget(c),a.checked=e.checked,typeof a.onchange=="function"))a.onchange();
return b=="selected"?!1:d}}});f.extend({iframe:{adaptSelf:function(){bg.iframe.adapt(self)},adapt:function(a,b){var c,d,e;if(!(null==a||a.name=="")&&a.parent!=a&&!(a.parent==g.top&&a.parent.document.body.style.overflowY=="hidden"))if(c=a.parent.document.getElementsByName(a.name),!(c.length<1)){c=c[0];if(c!=null&&(c.scrolling=="no"||c.className=="autoadapt"))if(d=a.document.body.scrollHeight+(null==b?0:b),e=0,c.style.height&&(e=parseInt(c.style.height.substring(0,c.style.height.length-2))),d>0&&d>
e)c.style.height=d+"px",bg.logger.debug("adapt frame:"+a.name+" height "+c.style.height);bg.iframe.adapt(a.parent)}}}});f.extend({form:{submit:function(a,b,c,d,e,i){var h,g;typeof a=="string"&&(a=document.getElementById(a));if(d){h=null;if(typeof d=="function")try{h=d(a)}catch(j){alert(j);return}else h=eval(d);if(h==!1)return}if(a.onsubmit){h=null;try{h=a.onsubmit()}catch(k){alert(k);return}if(h==!1)return}(c=null!=c?c:a.target)||(c=bg.findTarget(a));if(b==null)b=a.action;b.indexOf("http://")==0&&
(b=b.substring(b.indexOf("/",7)));if(null==e||e)e=bg.isAjaxTarget(c);h=a.target;d=a.action;a.action=b;if(e){(null==a.id||""==a.id)&&a.setAttribute("id",a.name);e=a.id+"_submit";h=document.getElementById(e);if(null==h)h=document.createElement("input"),h.setAttribute("id",e),h.setAttribute("type","submit"),h.style.display="none",a.appendChild(h);g={id:e,jqueryaction:"button",targets:c,href:"#"};typeof jQuery!="undefined"&&(i?jQuery.struts2_jquery.bind(jQuery("#"+e),g):f.history.historySubmit(a.id,b,
c));h.click();jQuery("#"+e).unbind()}else a.target=bg.normalTarget(c),a.submit(),a.target=h;if(a)a.action=d},submitId:function(a,b,c,d,e,g){var f=bg.input.getCheckBoxValues(b);null==c&&(c=!1);""==f?alert(c?"\u8bf7\u9009\u62e9\u4e00\u4e2a\u6216\u591a\u4e2a\u8fdb\u884c\u64cd\u4f5c":"\u8bf7\u9009\u62e9\u4e00\u4e2a\u8fdb\u884c\u64cd\u4f5c"):!c&&f.indexOf(",")>0?alert("\u8bf7\u4ec5\u9009\u62e9\u4e00\u4e2a"):(null!=d?a.action=d:d=a.action,bg.form.addInput(a,c?b+"s":b,f,"hidden"),(null==e||confirm(e))&&
bg.form.submit(a,d,null,null,g))},addInput:function(a,b,c,d){if(a[b]!=null&&typeof a[b]!="string")a[b].value=c;else{null==d&&(d="hidden");var e=document.createElement("input");e.setAttribute("name",b);e.setAttribute("value",c);e.setAttribute("type",d);a.appendChild(e)}},ecodeParams:function(a){if(""==a)return"";var a=a.split("&"),b="",c,d;for(c=0;c<a.length;c++)a[c]!=""&&(d=a[c].indexOf("="),b+="&"+a[c].substr(0,d),-1!=d&&(b+="=",b+=escape(a[c].substr(d+1))));return b},setSearchParams:function(a,
