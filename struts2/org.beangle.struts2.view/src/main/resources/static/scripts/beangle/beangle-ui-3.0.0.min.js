...
a.tagName.toLowerCase()!="table";)if(a=a.parentNode,null==a)break;if(null!=a){var c=0;jQuery("#"+a.id+" .gridselect").each(function(){var a=jQuery(this).find("input");a.length!=0&&(b.checked?(a.attr("checked","checked"),jQuery(this).parent("tr").addClass("griddata-selected"),c++):a.is(":checked")&&(a.removeAttr("checked"),jQuery(this).parent("tr").removeClass("griddata-selected")))});f.ui.grid.notifyGridbar(a.id,c)}},notifyGridbar:function(a,b){var c=function(){b>=2?jQuery(this).hasClass("toolbar-item-e1")?
