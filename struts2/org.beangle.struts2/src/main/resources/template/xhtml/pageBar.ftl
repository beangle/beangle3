...
<div [#if extra['cssClass']??]class="${extra['cssClass']}"[#else]class="pagebar"[/#if] [#if extra['cssStyle']??]style="${extra['style']}"[/#if]>
	[#if curPage.pageNo==1][@b.text name="page.first"/] [#else]
	<a href="#" onclick="bg.page.goPage('${pageId}',1)">[@b.text name="page.first"/]</a>
	<a href="#" onclick="bg.page.goPage('${pageId}',${curPage.previousPageNo})" >[@b.text name="page.previous"/]</a>
	[/#if]
	...
	<a href="#" onclick="bg.page.goPage('${pageId}',${curPage.nextPageNo})" >[@b.text name="page.next" /]</a>
	<a href="#" onclick="bg.page.goPage('${pageId}',${curPage.maxPageNo})" title="[@b.text name="page.last"/]">共${curPage.maxPageNo}页</a>
	[/#if]
