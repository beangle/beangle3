...
public class ReflectorTest {
  ...
  public void testGet() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    Assert.assertTrue(Integer.class.equals(PropertyUtils.getPropertyType(Role.class, "id")));
    Assert.assertTrue(Role.class.equals(PropertyUtils.getPropertyType(Role.class, "parent")));
    PropertyUtils.setProperty(new Role(), "id", 1);
  }
