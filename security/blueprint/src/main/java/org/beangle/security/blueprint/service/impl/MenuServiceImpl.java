...
import org.beangle.security.blueprint.model.Menu;
import org.beangle.security.blueprint.model.Menu;
import org.beangle.security.blueprint.model.MenuProfile;
 ...
 */
public class MenuServiceImpl extends AbstractHierarchyService<Menu> implements MenuService {
  ...
  @Override
  protected List<Menu> getTopNodes(Menu menu) {
  ...
  public void move(Menu menu, Menu location, int indexno) {
    this.move((Menu) menu, (Menu) location, indexno);
  }
