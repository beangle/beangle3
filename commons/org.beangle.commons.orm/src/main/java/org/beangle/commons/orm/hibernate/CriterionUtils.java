...
public final class CriterionUtils {
  ...
  public static Map<String, Object> getParamsMap(Entity<?> entity, MatchMode mode) {
    ...
    try {
      ...
      logger
          .error("[converToMap]:error occur in converToMap of bean" + entity + "with attr named " + attr, e);
    }
   ...
   * @param mode
   */
  private static void addCriterion(String nestedName, Object entity, String[] excludePropertes, String path,
      Object value, List<Criterion> criterions, MatchMode mode, boolean ignoreZero) {
  ...
  private static Map<String, Object> converToMap(String prefix, Component component, MatchMode mode) {
    ...
    try {
      ...
      logger.error("[converToMap]:error occur in converToMap of component" + component + "with attr named "
          + attr, e);
...
class NotEmptyPropertySelector implements PropertySelector {
