...
public class ToOneFkSecondPass extends FkSecondPass {
	...
	public ToOneFkSecondPass(
		...
		this.path = -1 !=lastIndex ? path.substring(lastIndex+1): path;
	}
    ...
    public boolean isInPrimaryKey() {
		...
		final PersistentClass persistentClass = mappings.getClass( entityName );
