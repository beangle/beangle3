package org.beangle.ems.security.session;
...
import org.beangle.ems.security.session.model.SessionActivityBean;
...
public class SessionInfoPersistHandler extends BaseServiceImpl implements LogoutHandler, InitializingBean {
	...
	//FIXME use logSessionActivity
	public void logout(HttpServletRequest request, HttpServletResponse response, Authentication auth) {
		SessionActivityBean record =new SessionActivityBean();
