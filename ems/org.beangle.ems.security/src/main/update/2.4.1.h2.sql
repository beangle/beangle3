...
alter table se_sessioninfoes add column expired_at datetime;
alter table se_sessioninfoes drop column expired;
--alter table se_sessioninfoes drop constraint primary key;
alter table se_sessioninfoes drop column id;
alter table se_sessioninfoes alter column sessionid rename to id;
alter table se_sessioninfoes add primary key (id);
