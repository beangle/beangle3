...
public class RestrictMetaAction extends EntityActionSupport {
	...
	public String editField() {
		PropertyMeta field = getEntity(PropertyMeta.class, "field");
		put("field", field);
	...
	public String saveField() {
		...
		PropertyMeta field = populateEntity(PropertyMeta.class, "field");
	...
	public String fields() {
		OqlBuilder<PropertyMeta> query = OqlBuilder.from(PropertyMeta.class, "field");
