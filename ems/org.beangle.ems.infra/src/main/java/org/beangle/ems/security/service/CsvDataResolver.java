...
public class CsvDataResolver implements UserDataResolver, UserDataProvider {
	...
	public String marshal(UserProperty property, Collection<?> items) {
	...
	public <T> List<T> unmarshal(UserProperty property, String source) {
	...
	public <T> List<T> getData(UserProperty property, String source) {
