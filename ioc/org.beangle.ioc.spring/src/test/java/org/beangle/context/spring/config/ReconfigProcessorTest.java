...
import org.beangle.context.spring.bean.AdvancedUserLdapProvider;
import org.beangle.context.spring.bean.UserDaoProvider;
import org.beangle.context.spring.bean.UserLdapProvider;
import org.beangle.context.spring.bean.UserService;
...
public class ReconfigProcessorTest {
  ...
  public void testGetDefinition() {
    ApplicationContext factory = new ClassPathXmlApplicationContext(
        "/org/beangle/commons/context/spring/context.xml");
    // two user provider
  ...
  public void testOverride() {
    ApplicationContext factory = new ClassPathXmlApplicationContext(
        "/org/beangle/commons/context/spring/context-config.xml");
    // userService
    UserService userService = (UserService) factory.getBean("userService");
