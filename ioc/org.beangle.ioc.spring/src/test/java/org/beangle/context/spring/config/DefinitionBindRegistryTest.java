...
import org.beangle.context.spring.bean.ProxyFactoryBean;
import org.beangle.context.spring.bean.TestDao;
import org.beangle.context.spring.bean.TestEntityDao;
import org.beangle.context.spring.config.SpringBindRegistry;
...
public class DefinitionBindRegistryTest {
  ...
  public void testGet() {
    ...
    reader.loadBeanDefinitions(new ClassPathResource(
        "/org/beangle/context/spring/context-registry.xml"));
