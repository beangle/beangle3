...
[@b.head/]
[#include "../status.ftl"/]
[@b.grid width="100%" datas=groups var="group" id="groupListTable" sortable="true" ]
[@b.gridbar]
	...
	bar.addItem("${b.text("action.export")}",action.exportData(null,"title,description,creator.title,createdAt,updatedAt,users","${b.text("common.title")},${b.text("common.description")},${b.text("common.creator")},${b.text("common.createdAt")},${b.text("common.updatedAt")},${b.text("group.users")}"),'excel.png');
[/@]
	[@b.row]
		...
		[@b.col width="15%" property="category.name" text="适用身份" /]
