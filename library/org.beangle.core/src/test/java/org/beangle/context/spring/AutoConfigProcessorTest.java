...
import org.beangle.context.testbean.SomeAction;
import org.beangle.context.testbean.TestService;
...
public class AutoConfigProcessorTest {
	...
	public void testGet() {
		...
		watch.start();
		ApplicationContext factory = new ClassPathXmlApplicationContext("/org/beangle/context/spring/context-auto.xml");
		testBean(factory);
