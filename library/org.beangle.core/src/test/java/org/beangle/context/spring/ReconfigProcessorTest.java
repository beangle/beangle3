...
import org.beangle.context.testbean.AdvancedUserLdapProvider;
import org.beangle.context.testbean.UserDaoProvider;
import org.beangle.context.testbean.UserLdapProvider;
import org.beangle.context.testbean.UserService;
...
public class ReconfigProcessorTest {
	...
	public void testGetDefinition() {
		ApplicationContext factory = new ClassPathXmlApplicationContext("/org/beangle/context/spring/context.xml");
		// two user provider
	...
	public void testOverride() {
		ApplicationContext factory = new ClassPathXmlApplicationContext("/org/beangle/context/spring/context-config.xml");
		// userService
		UserService userService = (UserService) factory.getBean("userService");
