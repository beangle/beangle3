...
import org.beangle.spring.testbean.AdvancedUserLdapProvider;
import org.beangle.spring.testbean.UserDaoProvider;
import org.beangle.spring.testbean.UserLdapProvider;
import org.beangle.spring.testbean.UserService;
...
public class ReconfigProcessorTest {
	...
	public void testGetDefinition() {
		ApplicationContext factory = new ClassPathXmlApplicationContext("/org/beangle/spring/config/context.xml");
		// two user provider
	...
	public void testOverride() {
		ApplicationContext factory = new ClassPathXmlApplicationContext("/org/beangle/spring/config/context-config.xml");
		// userService
		UserService userService = (UserService) factory.getBean("userService");
