 ...
 */
package org.beangle.util.inflector.lang.en;

import static org.beangle.util.inflector.rule.AbstractRegexReplacementRule.disjunction;
...
import org.beangle.util.inflector.RuleBasedPluralizer;
import org.beangle.util.inflector.rule.AbstractRegexReplacementRule;
import org.beangle.util.inflector.rule.CategoryInflectionRule;
import org.beangle.util.inflector.rule.IrregularMappingRule;
import org.beangle.util.inflector.rule.RegexReplacementRule;
import org.beangle.util.inflector.rule.SuffixInflectionRule;
...
public class EnNounPluralizer extends RuleBasedPluralizer {
	...
	private final List<Rule> rules = Arrays
			.asList(new Rule[] {
