...
public class SessionFactoryBean implements FactoryBean<SessionFactory>, Initializing, Disposable,
	 ...
	 * <p>
	 * Note: Can be omitted when all necessary properties and mapping resources are specified
	...
	public void init() throws Exception {
		...
		try {
			...
			configuration.setProperty(Environment.TRANSACTION_STRATEGY,
					BeangleTransactionFactory.class.getName());
	 ...
	 * <p>
	 * The default implementation creates a new Configuration instance. A custom implementation
	 * could prepare the instance in a specific way, or use a custom Configuration subclass.
	 * 
