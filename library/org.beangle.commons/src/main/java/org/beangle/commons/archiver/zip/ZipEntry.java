...
public class ZipEntry extends java.util.zip.ZipEntry implements Cloneable {
	...
	public ZipExtraField[] getExtraFields() {
		if (extraFields == null) { return new ZipExtraField[0]; }
	...
	public void removeExtraField(ZipShort type) {
		if (extraFields == null) { throw new java.util.NoSuchElementException(); }
		if (extraFields.remove(type) == null) { throw new java.util.NoSuchElementException(); }
		setExtra();
	}
	...
	public ZipExtraField getExtraField(ZipShort type) {
		if (extraFields != null) { return (ZipExtraField) extraFields.get(type); }
		return null;
	}
