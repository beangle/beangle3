...
[#assign refreshInterval=Parameters['interval']!"100"/]
[@b.grid items=sessioninfos var="sessioninfo" refresh="${refreshInterval}"]
	...
	[@b.row]
		[@b.boxcol/]
		[@b.col width="20%" title="sessioninfo.username" property="username"]
		...
		[@b.col width="12%" title="sessioninfo.os" property="os"/]
