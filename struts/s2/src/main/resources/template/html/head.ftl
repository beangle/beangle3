...
<html lang="zh_CN">
  ...
  ${b.script("bui","js/beangle-history.js")}
  ...
  <script type="text/javascript">
    ...
    beangle.register("${b.static_base()}/",{
        ...
        "beangle":{js:"bui/0.4.3/js/beangle.js"},
        "bootstrap":{js:"bootstrap/4.6.1/js/bootstrap.bundle.min.js",css:["bootstrap/4.6.1/css/bootstrap.min.css"]},
        "bui":{js:"bui/0.4.3/js/beangle-ui.js",css:["bui/0.4.3/css/beangle-ui.css"]},
        "bui-ajaxchosen":{js:"bui/0.4.3/js/beangle-ui-ajaxchosen.js",deps:["chosen"]},
        "bui-tabletree":{js:"bui/0.4.3/js/beangle-ui-tabletree.js",css:["bui/0.4.3/css/beangle-ui-tabletree.css"]},
        "chosen":{js:"chosen/1.8.7/chosen.jquery.min.js",css:["chosen/1.8.7/chosen.min.css"]},
        "echarts":{js:"echarts/5.3.1/dist/echarts.min.js"},
        "ems":{js:"ems/4.5.9/js/ems.js"},
        "ems-nav":{js:"ems/4.5.9/js/nav.js",css:["ems/4.5.9/css/nav.css"],deps:["adminlte","ems"]},
        ...
        "history":{js:"bui/0.4.3/js/beangle-history.js"},
        ...
        "jquery-pstrength":{js:"bui/0.4.3/js/jquery-pstrength,jquery-pstrength_zh.js",css:["bui/0.4.3/css/jquery.pstrength.css"]},
        "jquery-treetable":{js:"bui/0.4.3/js/jquery-treetable.js",css:["bui/0.4.3/css/jquery.treetable.css"]},
        "jquery-ui":{js:"jquery-ui/1.13.1/jquery-ui.min.js",css:["jquery-ui/1.13.1/jquery-ui.min.css"]},
        "jquery-validity":{js:"bui/0.4.3/js/jquery-validity.js",css:["bui/0.4.3/css/jquery.validity.css"]},
